...
F5::Reload
;---------------------------------
;  鼠标键盘luxiang（傻瓜版） v1.0  By FeiYue
;
;  使用说明：
;  1、F1lu，F2tinglu或huifang，F3huifang，F4chakan和修改记录
;  2、chakan的记录可以复制到用户脚本中使用（就是太长了^_^）
;---------------------------------
;-- lu热键
F1:: luxiang.lu()
;-- tinglu或huifang
...
lu() {
  ...
  CoordMode, ToolTip
  ToolTip, 正在lu——, A_ScreenWidth//2-100, 0
  ...
  SetTimer, %r%, Off
  this.SetHotkey(0)
  this.text .= "luxiang.huifang(s)`r`n"
  ToolTip
  return this.text
}
huifang(s="") {
